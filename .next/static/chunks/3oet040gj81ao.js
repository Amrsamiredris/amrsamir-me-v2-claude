(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,51265,e=>{"use strict";var t=e.i(54707),i=e.i(30669);e.s(["default",0,function(){(0,i.useRef)(null);let a=(0,i.useRef)(!1);return(0,i.useEffect)(()=>{a.current||(a.current=!0,e.A(3235).then(e=>{e.startAdmin()}))},[]),(0,t.jsxs)("div",{"data-theme":"classic-black",style:{minHeight:"100vh",width:"100vw",background:"var(--bg-primary)"},children:[(0,t.jsx)("div",{className:"bg-shape shape1"}),(0,t.jsx)("div",{className:"bg-shape shape2"}),(0,t.jsx)("div",{className:"bg-shape shape3"}),(0,t.jsx)("div",{id:"app",dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}])},3235,e=>{e.v(t=>Promise.all(["static/chunks/1sqc4cal-9zne.js","static/chunks/0wqdwr3kq_ex1.js"].map(t=>e.l(t))).then(()=>t(92501)))}]);